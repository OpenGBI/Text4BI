...
from cardsTemplates2.ProportionData import ProportionData11,ProportionData22,ProportionData33
# 读取Global Superstore的CSV文件
data = pd.read_csv(r'./Datasets/Global Superstore.csv')
def changeProportion2(drillDownGroup):
    ...
    if(drillDownGroup=="gender"):
        data_export=ProportionData11["data"]
    if(drillDownGroup=="product"):
        data_export=ProportionData22["data"]
    if(drillDownGroup=="improvement areas"):
