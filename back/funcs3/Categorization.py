...
from cardsTemplates3.CategoryData import Category11,Category22
# 读取Global Superstore的CSV文件
data = pd.read_csv(r'./Datasets/Global Superstore.csv')
def changeCategorization3(drillDownGroup,topk):
    ...
    print(topk)
    if(drillDownGroup=="Temperature"):
        data_export=Category11
    if(drillDownGroup=="CPI"):
