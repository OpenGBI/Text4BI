...
const iniData: Card[] = [
  {
    ...
    paragraph: [
      ...
      },
      {
        ...
        metadata: {
          detail: [
            { category: 'aaa', value: 3 },
            { category: 'aaa', value: 7 },
            { category: 'aaa', value: 2 },
            { category: 'aaa', value: 3 },
            { category: 'aaa', value: 4 },
            { category: 'aaa', value: 5 },
            { category: 'aaa', value: 6 },
            { category: 'aaa', value: 7 },
            { category: 'aaa', value: 8 },
            { category: 'aaa', value: 7 },
            { category: 'aaa', value: 3 },
            { category: 'aaa', value: 7 },
            { category: 'bbbb', value: 3 },
            { category: 'bbbb', value: 7 },
            { category: 'bbbb', value: 4 },
            { category: 'bbbb', value: 5 },
            { category: 'bbbb', value: 3 },
            { category: 'bbbb', value: 7 },
            { category: 'bbbb', value: 3 },
            { category: 'bbbb', value: 7 },
